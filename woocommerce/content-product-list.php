...
$classes[] = 'col-sm-12 col-md-12 product-list-item';
?>
    ...
    <div class="product-inner">
        <div class="row">
                    ...
                    <a href="<?php esc_url(the_permalink()); ?>">
                        ...
                        if (version_compare(WOOCOMMERCE_VERSION, "2.0.0") >= 0) {
                            ...
                            if ($attachment_ids) {
                                ...
                                echo '<div class="product-image front-image">' . wp_kses($image_html, array('img' => array('src' => array(), 'alt' => array(), 'class' => array()))) . '</div>';
                                ...
                                foreach ($attachment_ids as $attachment_id) {
                                    ...
                                    echo '<div class="product-image back-image">' . wp_kses(wp_get_attachment_image( $attachment_id, 'shop_catalog' ), array('img' => array('src' => array(), 'alt' => array(), 'class' => array()))) . '</div>';
                                ...
                                echo '<div class="product-image front-image">' . wp_kses($image_html, array('img' => array('src' => array(), 'alt' => array(), 'class' => array()))) . '</div>';
                                echo '<div class="product-image back-image">' . wp_kses($image_html, array('img' => array('src' => array(), 'alt' => array(), 'class' => array()))) . '</div>';
                            ...
                            if ($attachments) {
                                ...
                                foreach ($attachments as $key => $attachment) {
                                    ...
                                    echo '<div class="product-image">' . wp_kses(wp_get_attachment_image( $attachment_id, 'shop_catalog' ), array('img' => array('src' => array(), 'alt' => array(), 'class' => array()))) . '</div>';
            ...
            <div class="col-sm-8 col-md-8">
                <div class="product-details al-left">
                    <h3><a href="<?php esc_url(the_permalink()); ?>"><?php the_title(); ?></a></h3>
                    <?php
                    $size = sizeof(get_the_terms($post->ID, 'product_cat'));
                    do_action('woocommerce_after_shop_loop_item_title');
                    echo '<div class="short-description">' . apply_filters( 'woocommerce_short_description', $post->post_excerpt ) . '</div>';
                    ?>
                    <div class="product-action-bottom al-center clearfix">
                        <?php
